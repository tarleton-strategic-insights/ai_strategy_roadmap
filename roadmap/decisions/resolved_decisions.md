...
flip charts (see `pac_retreat/analysis/vision_statements_analysis.md`) into one
...
`pac_retreat/analysis/strategic_insights/cook/vision_synthesis.yaml`; `pac_report.md`
