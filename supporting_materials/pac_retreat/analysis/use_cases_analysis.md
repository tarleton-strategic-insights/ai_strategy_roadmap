...
Source: `pac_retreat/sources/event_artifacts/images/use_cases/` (9 flip-chart photos from a Gartner-facilitated workshop, breakout group notes, sent by Drew Doolin, 2026-07-30). Categorization framework adjudicated — see ADR-8 and ADR-9 in [resolved_decisions.md](../../other/decisions/resolved_decisions.md).

---

## Part 1 — Direct Extraction (enumerated)

Defined in [raw_items.yaml](strategic_insights/cook/use_cases/raw_items.yaml).
...
Defined in [unique_items.yaml](strategic_insights/cook/use_cases/unique_items.yaml).
...
Defined in [outcomes.yaml](strategic_insights/cook/use_cases/outcomes.yaml) and [resources.yaml](strategic_insights/cook/use_cases/resources.yaml) using deduplicated (unique) items.
