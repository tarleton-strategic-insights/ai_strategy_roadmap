...
flip charts (see `supporting_materials/pac_retreat/analysis/vision_statements_analysis.md`) into one
adjudicated statement, closing out the "not yet adjudicated" status that section
carried since the retreat. Sole source of truth for the wording is
`supporting_materials/pac_retreat/analysis/strategic_insights/cook/vision_synthesis.yaml`; `pac_report.md`
...
remains `supporting_materials/pac_retreat/analysis/strategic_insights/cook/vision_synthesis.yaml`;
