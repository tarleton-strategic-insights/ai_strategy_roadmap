...
Slide 3 of `supporting_materials/pac_retreat/sources/event_artifacts/slides/Richardson_AI_landscape.pdf`
...
`supporting_materials/other/post_retreat_discussion.md`'s milestone table), it should
...
Many of the roles in AI_strategy_and_roadmap.md's "AI Solutions Delivery" category (Chief
engineer, Project manager, Engineer, Operations, Product support) are probably not
